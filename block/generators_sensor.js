module.exports = function(Blockly){
  'use strict';
	...
	Blockly.JavaScript['dhtesp_setup_MySTEMIoTkids'] = function(block) {
	...
	Blockly.JavaScript['dhtesp_read_temp_MySTEMIoTkids'] = function(block) {
	  var variable_instance = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('instance'), Blockly.Variables.NAME_TYPE);
	  var code = `${variable_instance}.readTemperature()`;
	  return [code, Blockly.JavaScript.ORDER_ATOMIC];
	};

	Blockly.JavaScript['dhtesp_read_humid_MySTEMIoTkids'] = function(block) {
	  var variable_instance = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('instance'), Blockly.Variables.NAME_TYPE);
	...
	Blockly.JavaScript['ds18b20_init_MySTEMIoTkids'] = function(block) {
	  var number_pin = block.getFieldValue('pin');
	  var code = `#EXTINC
	#include <OneWire.h>
	...
	Blockly.JavaScript['ds18b20_get_devices_num_MySTEMIoTkids'] = function(block) {
	  var code = `sensors_ds18b20.getDS18Count()`;
	  return [code, Blockly.JavaScript.ORDER_ATOMIC];
	};

	Blockly.JavaScript['ds18b20_get_temperature_MySTEMIoTkids'] = function(block) {
