module.exports = function(Blockly) {
  ...
  Blockly.Blocks["ADC_MySTEMIoTkids"] = {
    init: function() {
  ...
  Blockly.Blocks["IN_MySTEMIoTkids"] = {
    init: function() {
      this.appendDummyInput()
          .appendField("IN")
          .appendField(new Blockly.FieldDropdown([
  ...
  Blockly.Blocks["IN_PULLUP_MySTEMIoTkids"] = {
    init: function() {
      this.appendDummyInput()
  ...
  Blockly.Blocks['OUT_MySTEMIoTkids'] = {
    init: function() {
      this.appendDummyInput()
        .appendField("OUT")
        .appendField(new Blockly.FieldDropdown([
   ...
   Blockly.Blocks['Buzzer_MySTEMIoTkids'] = {
    init: function() {
      this.appendDummyInput()
  ...
  Blockly.Blocks['Knob_MySTEMIoTkids'] = {
    init: function() {
      this.appendDummyInput()
  ...
  Blockly.Blocks["SW_MySTEMIoTkids"] = {
    init: function() {
      this.appendDummyInput()
          .appendField("Switch ")
          .appendField(new Blockly.FieldDropdown([
