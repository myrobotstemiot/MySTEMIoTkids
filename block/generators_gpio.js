module.exports = function(Blockly) {
  "use strict";
  Blockly.JavaScript["ADC_MySTEMIoTkids"] = function(block) {
    let dropdown_CH = block.getFieldValue("pin");
    let code = `analog(${dropdown_CH})`;
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
  };
  Blockly.JavaScript["IN_MySTEMIoTkids"] = function(block) {
    let dropdown_CH = block.getFieldValue("pin");
    let code = `in(${dropdown_CH})`;
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
  };
  Blockly.JavaScript["IN_PULLUP_MySTEMIoTkids"] = function(block) {
    let dropdown_CH = block.getFieldValue("pin");
    let code = `in_pullup(${dropdown_CH})`;
    return [code, Blockly.JavaScript.ORDER_ATOMIC];
  };
  Blockly.JavaScript["OUT_MySTEMIoTkids"] = function(block) {
  ...
  Blockly.JavaScript["Buzzer_MySTEMIoTkids"] = function(block) {
  ...
  Blockly.JavaScript['Knob_MySTEMIoTkids'] = function(block) {  
  ...
  Blockly.JavaScript["io_pin_dummy_input"] = function(block) {
    ...
    Blockly.JavaScript["SW_MySTEMIoTkids"] = function(block) {
    let dropdown_CH = block.getFieldValue("pin");
